        ...
        <form method="POST" action="{{ route('dg.projets.store') }}" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="isduplex" name="isduplex" value="1" {{ old('isduplex') ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="isappartement" name="isappartement" value="1" {{ old('isappartement') ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="isvillabase" name="isvillabase" value="1" {{ old('isvillabase') ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="isterrains" name="isterrains" value="1" {{ old('isterrains') ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('prix_duplex') is-invalid @enderror" 
                               id="prix_duplex" name="prix_duplex" value="{{ old('prix_duplex') }}" min="0">
                        @error('prix_duplex')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('prix_appartement') is-invalid @enderror" 
                               id="prix_appartement" name="prix_appartement" value="{{ old('prix_appartement') }}" min="0">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('prix_villa') is-invalid @enderror" 
                               id="prix_villa" name="prix_villa" value="{{ old('prix_villa') }}" min="0">
                        @error('prix_villa')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('prix_terrains') is-invalid @enderror" 
                               id="prix_terrains" name="prix_terrains" value="{{ old('prix_terrains') }}" min="0">
                        @error('prix_terrains')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
