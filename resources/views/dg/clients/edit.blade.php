...
<div class="data-table-container">
    ...
    <div style="padding: 20px;">
        <form method="POST" action="{{ route('dg.clients.update', $client) }}" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nom_prenom') is-invalid @enderror" 
                               id="nom_prenom" name="nom_prenom" value="{{ old('nom_prenom', $client->nom_prenom) }}" required>
                        @error('nom_prenom')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('lieu_naissance') is-invalid @enderror" 
                               id="lieu_naissance" name="lieu_naissance" value="{{ old('lieu_naissance', $client->lieu_naissance) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nationalite') is-invalid @enderror" 
                               id="nationalite" name="nationalite" value="{{ old('nationalite', $client->nationalite) }}" required>
                        @error('nationalite')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('salaire_mensuel') is-invalid @enderror" 
                               id="salaire_mensuel" name="salaire_mensuel" value="{{ old('salaire_mensuel', $client->salaire_mensuel) }}" min="0">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('categorie_client') is-invalid @enderror" 
                            ...
                            <option value="individuel" {{ old('categorie_client', $client->categorie_client) == 'individuel' ? 'selected' : '' }}>Individuel</option>
                            <option value="association" {{ old('categorie_client', $client->categorie_client) == 'association' ? 'selected' : '' }}>Association</option>
                            <option value="syndicat" {{ old('categorie_client', $client->categorie_client) == 'syndicat' ? 'selected' : '' }}>Syndicat</option>
                            <option value="diaspora" {{ old('categorie_client', $client->categorie_client) == 'diaspora' ? 'selected' : '' }}>Diaspora</option>
                            <option value="mutuelle" {{ old('categorie_client', $client->categorie_client) == 'mutuelle' ? 'selected' : '' }}>Mutuelle</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('situation_matrimoniale') is-invalid @enderror" 
                            ...
                            <option value="celibataire" {{ old('situation_matrimoniale', $client->situation_matrimoniale) == 'celibataire' ? 'selected' : '' }}>Célibataire</option>
                            <option value="marie" {{ old('situation_matrimoniale', $client->situation_matrimoniale) == 'marie' ? 'selected' : '' }}>Marié(e)</option>
                            <option value="divorce" {{ old('situation_matrimoniale', $client->situation_matrimoniale) == 'divorce' ? 'selected' : '' }}>Divorcé(e)</option>
                            <option value="veuf" {{ old('situation_matrimoniale', $client->situation_matrimoniale) == 'veuf' ? 'selected' : '' }}>Veuf/Veuve</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('nombre_enfants') is-invalid @enderror" 
                               id="nombre_enfants" name="nombre_enfants" value="{{ old('nombre_enfants', $client->nombre_enfants) }}" min="0">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ayant_droit') is-invalid @enderror" 
                               id="ayant_droit" name="ayant_droit" value="{{ old('ayant_droit', $client->ayant_droit) }}">
                        @error('ayant_droit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('nature_piece') is-invalid @enderror" 
                            ...
                            <option value="">Sélectionner</option>
                            <option value="cni" {{ old('nature_piece', $client->nature_piece) == 'cni' ? 'selected' : '' }}>CNI</option>
                            <option value="passeport" {{ old('nature_piece', $client->nature_piece) == 'passeport' ? 'selected' : '' }}>Passeport</option>
                            <option value="carte_consulaire" {{ old('nature_piece', $client->nature_piece) == 'carte_consulaire' ? 'selected' : '' }}>Carte Consulaire</option>
                            <option value="id" {{ old('nature_piece', $client->nature_piece) == 'id' ? 'selected' : '' }}>ID</option>
                        </select>
                        @error('nature_piece')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('fichier_piece') is-invalid @enderror" 
                               id="fichier_piece" name="fichier_piece" value="{{ old('fichier_piece', $client->fichier_piece) }}">
                        @error('fichier_piece')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
