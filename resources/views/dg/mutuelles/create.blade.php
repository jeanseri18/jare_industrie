...
@section('title', 'Créer une Mutuelle')
...
<div class="data-table-container">
    ...
    <div style="padding: 20px;">
        <form method="POST" action="{{ route('dg.mutuelles.store') }}" class="needs-validation" novalidate>
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="est_active" name="est_active" value="1" {{ old('est_active', true) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Créer la Mutuelle
                    </button>
                    <a href="{{ route('dg.mutuelles.index') }}" class="btn btn-secondary">
...
(function() {
    ...
    window.addEventListener('load', function() {
        ...
        if (projectSelect) {
                                ...
                                biens.forEach(bien => {
                                    ...
                                    html += `
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="biens[${bien.id}]" class="form-control" placeholder="Prix spécial" min="0" step="1">
            ...
            // Trigger change if value is pre-selected (e.g. back from validation error)
