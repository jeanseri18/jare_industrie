...
<div class="data-table-container">
    <div class="card-header-custom d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('comptable.clients.index') }}" class="btn btn-outline-secondary">
            Retour à la liste
        </a>
    </div>
            ...
            <div class="col-md-3">
                <div class="card-custom">
                    <div class="card-body-custom text-center">
                        ...
                        <div class="fs-3 fw-bold text-primary">{{ $client->souscriptions->count() }}</div>
            ...
            <div class="col-md-3">
                <div class="card-custom">
                    <div class="card-body-custom text-center">
                        ...
                        <div class="fs-4 fw-bold text-success">{{ number_format($client->salaire_mensuel ?? 0, 0, ',', ' ') }} <span class="text-muted fs-6">FCFA</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card-custom">
                    <div class="card-body-custom text-center">
                        ...
                        <div class="fs-3 fw-bold text-info">{{ $client->nombre_enfants ?? 0 }}</div>
            ...
            <div class="col-md-3">
                <div class="card-custom">
                    <div class="card-body-custom text-center">
                        ...
                        <div class="fw-bold text-warning">{{ ucfirst($client->situation_matrimoniale ?? 'N/A') }}</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table-custom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $souscription->projet->nom ?? $souscription->programme ?? 'Non défini' }}</td>
                                        <td>{{ ucfirst($souscription->type_logement ?? 'Non défini') }}</td>
                                        <td><strong>{{ number_format($souscription->prix_logement ?? 0, 0, ',', ' ') }} FCFA</strong></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('comptable.paiements.souscription', $souscription) }}" class="btn btn-sm btn-info text-white" title="Gérer les paiements">
                                                    <i class="fas fa-money-bill-wave"></i> Gérer Paiements
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
