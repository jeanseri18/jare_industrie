...
<div class="container">
    ...
    <form id="subscriptionForm" action="{{ route('chef_commercial.souscriptions.store') }}" method="POST" enctype="multipart/form-data" style="{{ session('success') ? 'display:none' : '' }}">
        @csrf
    ...
    <div class="success-screen {{ session('success') ? 'active' : '' }}" id="successScreen">
        ...
        <button type="button" class="btn-primary" onclick="window.location.href='{{ route('chef_commercial.dashboard') }}'">Retour à la page d’accueil</button>
    </div>
