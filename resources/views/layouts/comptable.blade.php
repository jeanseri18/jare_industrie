...
<head>
    ...
    <style>
        * {
        ...
        .modal .btn-outline-secondary:hover { background-color: #f9fafb; }
        .modal .btn-primary {
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('comptable.apports-initiaux') }}" class="nav-link {{ request()->routeIs('comptable.apports-initiaux') ? 'active' : '' }}">
                    <i class="fas fa-money-bill-wave"></i>
                    <span>Apports initiaux</span>
                </a>
            </li>

            <li class="nav-item">
                <a href="{{ route('comptable.suivi-paiements-projet') }}" class="nav-link {{ request()->routeIs('comptable.suivi-paiements-projet') ? 'active' : '' }}">
                    <i class="fas fa-chart-line"></i>
                    <span>Suivi de paiements projet</span>
                </a>
            </li>
